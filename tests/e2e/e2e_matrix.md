...
|---|---|---|---|---|---|---|---|
| Ubuntu 24.04 | GNOME | Wayland |  |  | partial-pass | `tests/e2e/results/2026-03-08-ubuntu24.04-first-field.md` | apt/setup/apply/rescue/panic/suggest OK; snap Firefox flow patched (alias + DBus wrapper handling), live re-run pending; daemon package not installed by default |
